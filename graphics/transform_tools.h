...
public:
	 ...
	 */
	static Common::FloatPoint transformPoint(Common::FloatPoint point, const float rotate, const Common::Point32 &zoom, const bool mirrorX = false, const bool mirrorY = false);
	 ...
	 */
	static Common::Rect32 newRect(const Common::Rect32 &oldRect, const TransformStruct &transform, Common::Point32 *newHotspot);
};
