...
void TransformStruct::init(Common::Point32 zoom, uint32 angle, Common::Point32 hotspot, bool alphaDisable, TSpriteBlendMode blendMode, uint32 rgbaMod, bool mirrorX, bool mirrorY, Common::Point32 offset) {
	_zoom = zoom;
	_angle = angle;
	_hotspot = hotspot;
...
TransformStruct::TransformStruct(int32 zoomX, int32 zoomY, uint32 angle, int32 hotspotX, int32 hotspotY, TSpriteBlendMode blendMode, uint32 rgbaMod, bool mirrorX, bool mirrorY, int32 offsetX, int32 offsetY) {
	init(Common::Point32(zoomX, zoomY),
		angle,
		Common::Point32(hotspotX, hotspotY),
		false,
		blendMode,
		rgbaMod,
		mirrorX, mirrorY,
		Common::Point32(offsetX, offsetY));
}
...
TransformStruct::TransformStruct(float zoomX, float zoomY, uint32 angle, int32 hotspotX, int32 hotspotY, TSpriteBlendMode blendMode, uint32 rgbaMod, bool mirrorX, bool mirrorY, int32 offsetX, int32 offsetY) {
	init(Common::Point32((int32)(zoomX / 100.0 * kDefaultZoomX),
...
TransformStruct::TransformStruct(int32 zoomX, int32 zoomY, TSpriteBlendMode blendMode, uint32 rgbaMod, bool mirrorX, bool mirrorY) {
	init(Common::Point32(zoomX, zoomY),
		kDefaultAngle,
		Common::Point32(kDefaultHotspotX, kDefaultHotspotY),
		false,
		blendMode,
		rgbaMod,
		mirrorX,
		mirrorY,
		Common::Point32(kDefaultOffsetX, kDefaultOffsetY));
}
...
TransformStruct::TransformStruct(int32 numTimesX, int32 numTimesY) {
	init(Common::Point32(kDefaultZoomX, kDefaultZoomY),
		kDefaultAngle,
		Common::Point32(kDefaultHotspotX, kDefaultHotspotY),
		false,
		BLEND_NORMAL,
